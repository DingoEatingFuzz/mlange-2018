...
I could make a plea to try to get Adobe to open source Flash player, but that was [already attempted once](https://github.com/open-source-flash/open-source-flash).
